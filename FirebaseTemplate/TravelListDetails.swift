                                        ...
                                        .foregroundColor(Color(.white))
                                                ...
                                                .onTapGesture {
                                                    ...
                                                    if (self.newNameSpend == ""){
                                                        ...
                                                        self.refresh = true
                                                        self.env.currentTravelList.spendMoney.append(SpendMoney(spendName: self.newNameSpend, id: ""))
                                         ...
                                         Image(systemName: "plus").imageScale(.large)
                                            ...
                                            .onTapGesture {
                                                ...
                                                { }  // if both field empty
                                                    ...
                                                    self.refresh = true
                                                    self.env.currentTravelList.beforetraveling.append(BeforeTraveling(beforeName: self.newNameBefore, beforePrice: self.newPriceBefore, id: ""))
                                            ...
                                            Image(systemName: "plus").imageScale(.large)
                                                ...
                                                .onTapGesture {
                                                    ...
                                                    { }  // if both field empty
                                                        ...
                                                        self.refresh = true
                                                        self.env.currentTravelList.aftertraveling.append(AfterTraveling(afterName: self.newNameAfter, afterPrice: self.newPriceAfter, id: ""))
                                               ...
                                               Image(systemName: "plus").imageScale(.large)
                                                    ...
                                                    .onTapGesture {
                                                        ...
                                                        { }  // if both field empty
                                                            ...
                                                            self.refresh = true
                                                            self.env.currentTravelList.others.append(Others(otherName: self.newNameOthers, otherPrice: self.newPriceOthers, id: ""))
