...
//    @Published var currentLista : Lista = Lista(givenName: "", budget: "", id: "", type: "travel", remaining: "")
    ...
    @Published var currentTravelList : TravelList = TravelList( lista: Lista(givenName: "", budget: "", id: "", type: "travel", remaining: "") , id: "", spendMoney: [], others: [], beforetraveling: [], aftertraveling: [])
